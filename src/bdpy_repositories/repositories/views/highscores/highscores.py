...
class PlayerHiscoreDataBase(BaseModel):
    timestamp: datetime
    ts_date: Optional[datetime]
    player_id: int
    total: int = 0
    attack: int = 0
    defence: int = 0
...
class PlayerHiscoreDataCreate(PlayerHiscoreDataBase):
    pass

class PlayerHiscoreDataLatestBase(PlayerHiscoreDataBase):
    timestamp: datetime
    ts_date: Optional[datetime]
    player_id: int
    total: int = 0
...
class PlayerHiscoreDataBaseXPChange(PlayerHiscoreDataBase):
    timestamp: datetime
    ts_date: Optional[datetime]
    player_id: int
    total: int = 0
